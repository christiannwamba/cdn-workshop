...
for(const target of ['production','preview']){
 const collector=target==='production'?'https://cdn-workshop-pilot-collector.vercel.app':'https://cdn-workshop-pilot-collector-git-codex-delivery-proof-cn-demos-vtest314.vercel.app';
